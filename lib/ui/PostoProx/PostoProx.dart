  ...
  Widget textDes(String text) {
    return Scaffold(
      body: Text(
        text,
        style:
            TextStyle(fontSize: 18, color: Colors.white, fontFamily: fontStyle),
...
// ignore: non_constant_identifier_names
          ...
          children: [
            ...
            MarkerLayer(markers: [
              Marker(
                  width: 50,
                  height: 50,
                  point: LatLng(-19.765578885587512, -47.95651791790178),
                  child: mark(
                      "UBS Juca Inácio",
              ...
              Marker(
                  width: 50,
                  height: 50,
                  point: LatLng(-19.767949107572836, -47.96950458779025),
                  child: mark(
                      "UBS Planalto",
              ...
              Marker(
                  width: 50,
                  height: 50,
                  point: LatLng(-19.77313384547731, -47.96084680830409),
                  child: mark(
  ...
  Widget mark(String name, String ende, String dis, String tel,
      int pos) {
