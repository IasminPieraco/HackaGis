...
import 'package:seuamigodasaude/ui/Contatos/contatos.dart';
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text("Meu nome é Samoel seu auxiliar de navegação no celular, caso queira navegar por conta propria aperte em DESATIVAR",
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                // Coloque o código a ser executado ao confirmar aqui
                Navigator.of(context).pop(); // Fecha o pop-up
              },
              child: Text("ATIVAR",
  ...
  return [
    ...
    _buildMenuOption(
        ...
        onPressed: () {Navigator.push(
              context,
              MaterialPageRoute<void>(
                builder: (BuildContext context) => const ContatosStateful(),
                settings: const RouteSettings(name: '/contatos'),
              ));}),
    const SizedBox(height: 9), // Reduzimos a altura de 100 para 20
    _buildMenuOption(
        text: 'Assistente', icon: Icons.people_alt, onPressed: () => showCustomDialog(context)),
    SizedBox(height: 9), // Reduzimos a altura de 100 para 20
    _buildMenuOption(
